...
bio_data = "Name: Sara, Age: 25, Country: Bangladesh"
...
person_info = {"Name": "Alice", "Age": 30, "Country": "Canada"}
...
def find_bangladesh_numbers(text):
    pattern = r"\b(?:\+880|0088|0)(1[3-9]\d{8}|1[3-9]\d{2}-\d{6})\b"
...
01845-567567
"""
numbers = find_bangladesh_numbers(test_text)
print(numbers)
