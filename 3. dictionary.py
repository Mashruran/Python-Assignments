...
student["grades"]["History"] = 78
print("Added new subject and grade:")
print(student)

# Removing a subject and grade
del student["grades"]["Science"]
print("\nRemoved Science from grades:")
print(student)

# Modifying a grade
student["grades"]["Math"] = 92
print("\nModified Math grade:")
print(student)
...
for student_name, grades in students_grades.items():
    averages[student_name] = sum(grades) / len(grades)

# Print the average grades
print("Average grades for each student:")
for student_name, avg in averages.items():
    print(f"{student_name}: {avg:.2f}")
